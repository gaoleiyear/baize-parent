 ...
 *
 * @author lqw
 * @date 2020/09/21 9:57
 */
public class RedisUtil {

    /** logger */
    private static final Logger logger = LoggerFactory.getLogger(com.baize.base.common.util.RedisUtil.class);
    ...
    public void setIncrGener(String key,long value,Date expireTime) {
        RedisAtomicLong counter = new RedisAtomicLong(key, redisTemplate.getConnectionFactory());
        counter.set(value);
        counter.expireAt(expireTime);
    }
     ...
     */
    @SuppressWarnings("all")
    public long saddWithTime(String key, long time, TimeUnit timeUnit, Object... values) {
        try {
     ...
     * @return 成功个数
     */
    public long saddWithSecond(String key, long time, Object... values) {
     ...
     * @return
     */
    public boolean rpushWithTime(String key, long time, TimeUnit timeUnit, Object... value) {
        try {
            redisTemplate.opsForList().rightPush(key, value);
            if (time > 0) {
                expire(key, time, timeUnit);
     ...
     * @return
     */
    public boolean rpushWithSecond(String key, long time, Object... value) {
