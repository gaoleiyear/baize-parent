package com.baize.gateway.swagger;
 ...
 * @ConditionalOnProperty 通过@ConditionalOnProperty控制配置类是否生效,可以将配置与代码进行分离,实现了更好的控制配置
 *      prefix为配置文件中的前缀,
 *      havingValue是与配置的值对比值,当两个值相同返回true,配置类生效;
 *      配置文件中的代码gateWaySwagger.enable=true
 */
@Component
@Primary
@ConditionalOnProperty(prefix = "gateWaySwagger",value = {"enable"},havingValue = "true")
